...
- `mcp__aidan__jarvis_query tool_name="search_tools" args={}`
- `mcp__aidan__run_operation operation="agent_tools.list"
...
```
mcp__aidan__run_operation operation="agent_tools.create"
...
> Test it with `mcp__aidan__send_ai_call agent_id=<id>` to make sure the
